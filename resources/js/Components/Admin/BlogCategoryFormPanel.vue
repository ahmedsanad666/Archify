...
const onColorPickerInput = (event) => {
...
const submit = () => {
    ...
    if (isEdit.value) {
        form.put(
            route('admin.blog-categories.update', props.category.id),
            options,
        );
        return;
    }

    form.post(route('admin.blog-categories.store'), options);
};
</script>
                                ...
                                >
                                    ...
                                    >
                                        <div class="flex flex-col gap-xs">
                                            ...
                                            >
                                                {{ t('admin.blog_categories.color') }}
                                            </label>
                                            <div class="flex items-center gap-sm">
                                                <input
                                                    type="color"
                                                    class="size-10 shrink-0 cursor-pointer rounded-md border border-outline bg-surface-container p-1"
                                                ...
                                                <input
                                                    ...
                                                    maxlength="7"
                                                    placeholder="#f9ba7f"
                                                    class="flex-1 rounded-md border border-outline bg-surface-container px-sm py-sm font-mono text-body-md text-on-surface outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary/20"
                                                ...
                                                <div class="grid gap-md">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {{
                                                                t(
                                                                    'admin.blog_categories.slug_hint',
                                                                )
                                                            }}
                                                        </p>
                                                        <p
